...
exports.drawLine = function(ctx, setx1,sety1,setx2,sety2,lineColor,shadeColor,specialOrders){
...
exports.drawShape = function(ctx, points,lineColor,shadeColor){
	...
	for(var pt=0;pt<points.length-1;pt++){
		exports.drawLine(ctx, points[pt][0],points[pt][1],points[pt+1][0],points[pt+1][1],lineColor,shadeColor,null);
	...
	for(var drawy = miny; drawy < maxy; drawy += 14 * zoomfactor){
		...
		if(startdraw && enddraw){
			...
			exports.drawLine(ctx, startdraw, drawy, enddraw, drawy + 6 * zoomfactor, shadeColor, shadeColor, null);
			// if there is space before reaching the bottom of the shape, draw / back to the left edge
			if(maxy > drawy + 12 * zoomfactor){
				exports.drawLine(ctx, enddraw, drawy + 6 * zoomfactor, startdraw, drawy + 12 * zoomfactor, shadeColor, shadeColor, null);		
			}
		}
		// make the right-to-left shader line
		if(startright && endright){
			// draw a diagonal line from the right edge, / to the left edge
			exports.drawLine(ctx, startright, drawy, endright, drawy + 6 * zoomfactor, shadeColor, shadeColor, null);
			// if there is space before reaching the bottom of the shape, draw \ back to the right edge
			if(maxy > drawy + 12 * zoomfactor){
				exports.drawLine(ctx, endright, drawy + 6 * zoomfactor, startright, drawy + 12 * zoomfactor, shadeColor, shadeColor, null);		
			}
		}
	}
}